...
if (isset($_POST['login_button'])) {
    ...
    if ($urow['Password'] == $user_password) {
        ...
        $activities = ''; // Assuming 'Activities' should be an empty string by default

	$enter = "INSERT INTO tbl_userlogs (Login, Machineip, Userid, Count, Activities, Logout) 
	VALUES (?, ?, ?, '0', ?, NOW())";
$stmt = $db->prepare($enter);
$stmt->bind_param("ssss", $ldate, $mac, $userid, $activities);
$stmt->execute();
